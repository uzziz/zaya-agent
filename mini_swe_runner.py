#!/usr/bin/env python3
"""
SWE Runner with Zaya Trajectory Format

A runner that uses Zaya-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Zaya-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Zaya-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Zaya format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Zaya-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Zaya-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Zaya Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Zaya-Agent's built-in execution environments
    and outputs trajectories in Zaya-Agent format.
    """
    ...
    def _convert_to_zaya_format(
        ...
        """
        Convert internal message format to Zaya trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Zaya trajectory format
        trajectory = self._convert_to_zaya_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Zaya trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Zaya Trajectory Format")
    print("=" * 60)
