"""
Skills configuration for Zaya Agent.
`zaya skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.zaya/config.yaml under:
...
from zaya_cli.platforms import PLATFORMS as _PLATFORMS
