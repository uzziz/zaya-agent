...
Usage:
    zaya pairing list              # Show all pending + approved users
    zaya pairing approve <platform> <code>  # Approve a pairing code
    zaya pairing revoke <platform> <user_id> # Revoke user access
    zaya pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle zaya pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: zaya pairing {list|approve|revoke|clear-pending}")
        print("Run 'zaya pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'zaya pairing list' to see pending codes.\n")
