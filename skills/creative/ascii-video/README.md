...
Built for [Zaya Agent](https://github.com/NousResearch/zaya-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/zaya-agent/skills/creative/ascii-video`](https://github.com/NousResearch/zaya-agent/tree/main/skills/creative/ascii-video) via PR.
