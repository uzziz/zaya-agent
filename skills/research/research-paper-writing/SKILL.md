...
## Zaya Agent Integration

This skill is designed for the Zaya agent. It uses Zaya tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Zaya skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.zaya/plans/` | `skill_view("plan")` |
