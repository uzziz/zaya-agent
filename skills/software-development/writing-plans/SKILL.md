...
version: 1.1.0
author: Zaya Agent (adapted from obra/superpowers)
license: MIT
metadata:
  zaya:
...
> **For Zaya:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Zaya tools to understand the project:
