...
metadata:
  zaya:
    ...
    related_skills: [claude-code, zaya-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Zaya terminal. Codex is OpenAI's autonomous coding agent CLI.
