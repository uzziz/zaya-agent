...
TOOLSETS = {
    ...
    # ==========================================================================
    # Full Zaya toolsets (CLI + messaging platforms)
    #
    ...
    "zaya-email": {
        "description": "Email bot toolset - interact with Zaya via email (IMAP/SMTP)",
        "tools": _ZAYA_CORE_TOOLS,
        "includes": []
    },
    ...
    "zaya-sms": {
        "description": "SMS bot toolset - interact with Zaya via SMS (Twilio)",
        "tools": _ZAYA_CORE_TOOLS,
        "includes": []
    },
    ...
    "zaya-gateway": {
        ...
        "tools": [],
        "includes": ["zaya-telegram", "zaya-discord", "zaya-whatsapp", "zaya-slack", "zaya-signal", "zaya-bluebubbles", "zaya-homeassistant", "zaya-email", "zaya-sms", "zaya-mattermost", "zaya-matrix", "zaya-dingtalk", "zaya-feishu", "zaya-wecom", "zaya-wecom-callback", "zaya-weixin", "zaya-qqbot", "zaya-webhook"]
    }
}
