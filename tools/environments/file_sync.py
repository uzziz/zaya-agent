...
_FORCE_SYNC_ENV = "ZAYA_FORCE_FILE_SYNC"
...
def iter_sync_files(container_base: str = "/root/.zaya") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.zaya to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``ZAYA_FORCE_FILE_SYNC=1`` is set.
