...
Trust levels:
  - builtin:   Ships with Zaya. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.zaya/\.env|\~/\.zaya/\.env',
     "zaya_env_access", "critical", "exfiltration",
     "directly references Zaya secrets file"),
    ...
    (r'\.zaya/config\.yaml|\.zaya/SOUL\.md',
     "zaya_config_mod", "critical", "persistence",
     "references Zaya configuration files directly"),
