// =========================================================================
// Zaya Agent Landing Page — Interactions
// =========================================================================
...
const PLATFORMS = {
  linux: {
    command:
      "curl -fsSL https://raw.githubusercontent.com/xia-labs/zaya-agent/main/scripts/install.sh | bash",
    prompt: "$",
...
const demoSequence = [
  ...
  {
    type: "type",
    text: "Review the PR at xia-labs/zaya-agent#42 and fix any issues",
    delay: 30,
  },
  { type: "pause", ms: 600 },
  {
...
// --- Noise Overlay (ported from zaya-chat NoiseOverlay) ---
