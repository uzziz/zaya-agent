"""
Email platform adapter for the Zaya gateway.

Allows users to interact with Zaya by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Zaya Agent")
        ...
        msg_id = f"<zaya-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
