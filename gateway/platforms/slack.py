...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_zaya_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/zaya")
            async def handle_zaya_command(ack, command):
                await ack()
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "zaya_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "zaya_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "zaya_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "zaya_approve_once": "once",
            "zaya_approve_session": "session",
            "zaya_approve_always": "always",
            "zaya_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        from zaya_cli.commands import slack_subcommand_map
