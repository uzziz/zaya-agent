...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - zaya_home (str): The active ZAYA_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.zaya``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "zaya").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'zaya memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], zaya_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'zaya memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``zaya_home`` is the active ZAYA_HOME directory path.
