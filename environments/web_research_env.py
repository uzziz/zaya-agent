...
Inspired by: GroceryMind — production Zaya agent doing live web research
             across German grocery stores (firecrawl + zaya-agent)
"""
...
# Ensure zaya-agent root is on path
...
class WebResearchEnvConfig(ZayaAgentEnvConfig):
...
class WebResearchEnv(ZayaAgentBaseEnv):
    """
