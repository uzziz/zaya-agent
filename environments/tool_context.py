...
ALL zaya-agent tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all zaya-agent tools for a specific rollout.
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any zaya-agent tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("ZAYA_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("ZAYA_QUIET", None)
            else:
                os.environ["ZAYA_QUIET"] = _prev_quiet
