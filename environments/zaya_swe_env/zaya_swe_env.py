"""
ZayaSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser zaya
    run-api
    python environments/zaya_swe_env.py serve \\
...
class ZayaSweEnv(ZayaAgentBaseEnv):
    ...
    name = "zaya-swe"
    env_config_cls = ZayaSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[ZayaSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = ZayaSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepZaya-3-Llama-3-3B-Preview",
            tool_call_parser="zaya",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="zaya-swe",
        ...
        server_configs = [
            APIServerConfig(
                ...
                model_name="NousResearch/DeepZaya-3-Llama-3-3B-Preview",
