...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("zaya")
        class ZayaToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "zaya", "mistral", "llama3_json")
...
from environments.tool_call_parsers.zaya_parser import ZayaToolCallParser  # noqa: E402, F401
