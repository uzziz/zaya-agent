...
4. Name the token (e.g., "Zaya Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.zaya/.env`:
...
```bash
CANVAS="python $ZAYA_HOME/skills/productivity/canvas/scripts/canvas_api.py"
