...
Data file: $ZAYA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ZAYA_HOME = Path(os.environ.get("ZAYA_HOME", Path.home() / ".zaya"))
DATA_DIR = _ZAYA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
