...
DEFAULT_DATASETS = [
    ...
    "NousResearch/zaya-agent-megascience-sft1",
    "NousResearch/Zaya-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Zaya-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-zaya-agent"
]
