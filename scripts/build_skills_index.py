#!/usr/bin/env python3
"""Build the Zaya Skills Index — a centralized JSON catalog of all skills.
...
`zaya skills search/install` can use it without hitting the GitHub API.
...
# Ensure ZAYA_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("ZAYA_HOME", os.path.join(os.path.expanduser("~"), ".zaya"))
...
def main():
    print("Building Zaya Skills Index...", flush=True)
