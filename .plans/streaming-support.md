# Streaming LLM Response Support for Zaya Agent
...
```
ZAYA_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ZAYA_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `zaya_cli/config.py` | 1 | +streaming config defaults |
