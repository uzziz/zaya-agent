...
The main() function in zaya_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `zaya -c model`
...
def _build_parser():
    """Build a minimal replica of the zaya top-level parser."""
...
class TestSubparserRoutingFallback:
    ...
    def test_bare_zaya_defaults_to_none(self):
        parser, sub = _build_parser()
