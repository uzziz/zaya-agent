"""Tests for the interactive session browser (`zaya sessions browse`).
...
from zaya_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """zaya sessions browse should be parseable."""
        from zaya_cli.main import main as _main_entry
