"""Tests for zaya-api-server toolset and API server tool availability."""
import os
import json
...
class TestZayaApiServerToolset:
    """Tests for the zaya-api-server toolset definition."""

    def test_toolset_exists(self):
        ts = get_toolset("zaya-api-server")
        assert ts is not None

    def test_toolset_validates(self):
        assert validate_toolset("zaya-api-server")

    def test_toolset_includes_web_tools(self):
        tools = resolve_toolset("zaya-api-server")
...
class TestApiServerPlatformConfig:
    def test_platforms_dict_includes_api_server(self):
        ...
        assert PLATFORMS["api_server"]["default_toolset"] == "zaya-api-server"
...
class TestApiServerAdapterToolset:
    ...
    def test_create_agent_reads_config_toolsets(self):
        ...
        with patch("gateway.run._resolve_runtime_agent_kwargs") as mock_kwargs, \
            ...
            # No platform_toolsets override — should fall back to zaya-api-server default
