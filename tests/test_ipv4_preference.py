...
def _reload_constants():
    """Reload zaya_constants to get a fresh apply_ipv4_preference."""
    import zaya_constants
    importlib.reload(zaya_constants)
    return zaya_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_zaya_ipv4_patched", False) is True
