...
class TestToolsetConsistency:
    ...
    def test_zaya_platforms_share_core_tools(self):
        """All zaya-* platform toolsets should have the same tools."""
        platforms = ["zaya-cli", "zaya-telegram", "zaya-discord", "zaya-whatsapp", "zaya-slack", "zaya-signal", "zaya-homeassistant"]
