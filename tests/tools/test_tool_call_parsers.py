...
class TestParserRegistry:
    ...
    def test_zaya_parser_registered(self):
        parsers = list_parsers()
        assert "zaya" in parsers
...
class TestZayaParser:
    @pytest.fixture
    def parser(self):
        return get_parser("zaya")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["zaya"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use zaya format since that's universal
